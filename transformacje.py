...
class Transformacje:
    ...
    def plh2XYZ(self, phi, lam, h):
        ...
        f - szerokość geograficzna punktu | typ: lista
    ...
    def u2000(self, phi, lam):
        ...
        Parameters:
        -----------
        xgk : [float] : wspołrzędna x prostokątna lokalna na płaszczyżnie Gaussa-Krugera
        ygk : [float] : współrzędna y prostokątna lokalna na płaszczyźnie Gaussa-Krugera
    ...
    def Rneu(self, fi, l):
        ...
        l : [float] :wspołrzędna fi punktu początkowego układu lokalnego
